...
- Le spike des darknesses se fait on spawn au lieu d'être pull vers la team.
- Dans ce format, vous pouvez éventuellement ajouter un [fast wall](/tactics/in-depth-concepts#fast-wall-in-city) en city.
...
| MT | Pull necro lord au milieu de la trench. Fait les back tendrils avec TK pendant le 6-0. | [Ouvrir le rôle](/tactics/4-mesmers-6-0/mt) |
| TT | Moins de glitches à faire. | [Ouvrir le rôle](/tactics/4-mesmers-6-0/tt) |
...
<a className="sheet-link" href="https://docs.google.com/spreadsheets/d/1dbjrpHoNL4M5vv2LfoL-CXThFagY5E4vlqU5rBZi6rc/edit?gid=0#gid=0" target="_blank" rel="noopener noreferrer">
  <span className="sheet-link__icon" aria-hidden="true"></span>
  <span className="sheet-link__label">Ouvrir la sheet de spike 6-0</span>
</a>
