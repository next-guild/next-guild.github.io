...
const SEARCH_ENTRIES = [
    { title: '6-0 Rojway', path: '/tactics/6-0-rojway', text: 'roj ray of judgment smiting monks mantra iau mlk seeder ua tk mt tt emo' },
    { title: 'MT', displayTitle: '6-0 Rojway > MT', path: '/tactics/6-0-rojway/mt', text: 'rojway ray of judgment mt smiting' },
    { title: 'TT', displayTitle: '6-0 Rojway > TT', path: '/tactics/6-0-rojway/tt', text: 'rojway ray of judgment tt smiting' },
    { title: 'TK', displayTitle: '6-0 Rojway > TK', path: '/tactics/6-0-rojway/tk', text: 'rojway ray of judgment tk smiting' },
    { title: 'Mantra', displayTitle: '6-0 Rojway > Mantra', path: '/tactics/6-0-rojway/mantra', text: 'rojway ray of judgment mantra smiting' },
    { title: 'IAU', displayTitle: '6-0 Rojway > IAU', path: '/tactics/6-0-rojway/iau', text: 'rojway ray of judgment iau smiting' },
    { title: 'MLK', displayTitle: '6-0 Rojway > MLK', path: '/tactics/6-0-rojway/mlk', text: 'rojway ray of judgment mlk smiting' },
    { title: 'UA', displayTitle: '6-0 Rojway > UA', path: '/tactics/6-0-rojway/ua', text: 'rojway ray of judgment ua smiting' },
    { title: 'Emo', displayTitle: '6-0 Rojway > Emo', path: '/tactics/6-0-rojway/emo', text: 'rojway ray of judgment emo smiting' },
    { title: 'Smiter', path: '/tactics/gear/smiting-monk', text: 'rojway smiting monk radiant attunement staff 20/40 40/40 energy pcons' },
    ...
    { title: '6-0 Mezway', path: '/tactics/4-mesmers-6-0', text: '6-0 advanced roles iau mlk tk vor ua emo mt tt spiking guide' },
    { title: 'IAU', displayTitle: '6-0 Mezway > IAU', path: '/tactics/4-mesmers-6-0/iau', text: '6-0 iau mesmer c-target unstoppable' },
    { title: 'MLK', displayTitle: '6-0 Mezway > MLK', path: '/tactics/4-mesmers-6-0/mlk', text: '6-0 mlk monk lord killer backfire empathy' },
    { title: 'TK', displayTitle: '6-0 Mezway > TK', path: '/tactics/4-mesmers-6-0/tk', text: '6-0 tk mesmer' },
    { title: 'VoR', displayTitle: '6-0 Mezway > VoR', path: '/tactics/4-mesmers-6-0/vor', text: '6-0 vor visions of regret mesmer' },
    { title: 'UA', displayTitle: '6-0 Mezway > UA', path: '/tactics/4-mesmers-6-0/ua', text: '6-0 ua unyielding aura seed of life' },
    { title: 'Emo', displayTitle: '6-0 Mezway > Emo', path: '/tactics/4-mesmers-6-0/emo', text: '6-0 emo ether renewal bonding' },
    { title: 'MT', displayTitle: '6-0 Mezway > MT', path: '/tactics/4-mesmers-6-0/mt', text: '6-0 mt main tank shadow form' },
    { title: 'TT', displayTitle: '6-0 Mezway > TT', path: '/tactics/4-mesmers-6-0/tt', text: '6-0 tt trench tank shadow form' },
    ...
    { title: '5 Man', path: '/tactics/5man', text: '5 man ss necro tk memo emo tank advanced' },
    { title: 'SS', displayTitle: '5 Man > SS', path: '/tactics/5man/ss', text: '5 man ss necro spiteful spirit mark of pain curses edge of extinction winnowing' },
    { title: 'TK', displayTitle: '5 Man > TK', path: '/tactics/5man/tk', text: '5 man tk cave snakes city hill tendrils derv hill pain inverter' },
    { title: 'MeMo', displayTitle: '5 Man > MeMo', path: '/tactics/5man/memo', text: '5 man memo healing seed life bond derv hill mesmer' },
    ...
    { title: 'Necro Gear', path: '/tactics/gear/necro', text: 'necro gear curses soul reaping 40/40 fast cast pcons ss' },
